            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<?= base_url('auth/register') ?>" method="POST">
				...
				<div class="mb-3">
					...
					<input type="email" name="email" name="email" class="form-control" required placeholder="Enter your email" id="">
				</div>
				<div class="mb-3">
					<label for="email" class="form-label">Nama</label>
					<input type="text" name="nama" class="form-control" required placeholder="Enter your name" id="">
				</div>
