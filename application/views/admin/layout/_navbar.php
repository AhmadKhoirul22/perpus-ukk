                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <div class="dropdown-divider"></div>
										...
										<li>
                      <a class="dropdown-item" href="<?= base_url('admin/user/profile/'.$this->session->userdata('id_user')) ?>">
                        <i class="bx bx-user me-2"></i>
                        <span class="align-middle">Profile</span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="<?= base_url('admin/user/changepassword/'.$this->session->userdata('id_user')) ?>">
                        <i class="bx bx-user me-2"></i>
