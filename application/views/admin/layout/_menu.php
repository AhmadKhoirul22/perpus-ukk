...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?php if($menu == 'buku'){echo "active";} ?>">
              <a href="<?= base_url('admin/buku') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Buku</div>
              </a>
            </li>
						<li class="menu-item <?php if($menu == 'peminjaman'){echo "active";} ?>">
              <a href="<?= base_url('admin/peminjaman') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Peminjaman Buku</div>
              </a>
            </li>
						<li class="menu-item <?php if($menu == 'pengembalian'){echo "active";} ?>">
              <a href="<?= base_url('admin/pengembalian') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Pengembalian Buku</div>
              </a>
            </li>
            
						<li class="menu-item <?php if($menu == 'denda'){echo "active";} ?>">
              <a href="<?= base_url('admin/denda') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Denda</div>
              </a>
            </li>
